...
// Incluir el archivo de conexión a la base de datos y sesiones
include 'assets/includes/head.php'; // Asegúrate de que este archivo incluya la conexión a la base de datos y el inicio de sesión.

session_start(); // Inicia la sesión si aún no lo ha hecho
...
<head>
    ...
    <title>Mostrar Excel desde Google Sheets</title>
    <!-- CSS de Swiper -->
