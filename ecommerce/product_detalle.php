...
include 'config/productdetalle.php'; // Incluye el archivo que recupera los datos de los productos
...
<title><?php echo htmlspecialchars($product['category_name']); ?> - <?php echo htmlspecialchars($product['name']); ?></title>
    ...
    <?php endif; ?>
</h3><span class="product-available"><?php echo htmlspecialchars($product['stock']); ?></span>
							</div>
